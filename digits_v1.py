...
'''
---Version One Notes---
This program is meant to solve Digits, New York Times mini number game. 
Sadly, the game never made it out of beta :[ 
However, it is still a very interesting game, and made for a great coding project.
-----------------------
'''
...
def calculate_equation(num_array, opp_array, result_num):
    ...
    while correct_answer == False:
        ...
        if len(num_array) > 1:
            ...
            equation = equation + f"(Answer = {num_array[0]})"
            if num_array[0] == result_num:
